 ...
 *
 *   ANTHROPIC_API_KEY=sk-ant-... pnpm test -- tests/AnthropicAgentCore/AnthropicAgentCore.integration.test.ts
 */
...
describe.skipIf(!apiKey)('AnthropicAgentCore — integration', () => {
  function makeCore() {
